    ...
    <>
      ...
      >
        <div
          ...
          style={{
            backgroundImage: `url(${getTemplateImageUrl("yootheme/cache/28/international_outdoor_education_diploma_1-28796d56.jpeg")})`,
          }}
        >
          <div
              ...
              <div className="uk-panel uk-width-1-1">
                ...
                >
                  <p>
                    ...
                    perfect environment to grow into the outdoor educator you want
                    to be! I loved every minute!&quot; -Tom, UK (participant in
                    2018)
                  </p>
                </blockquote>
              </div>
                  ...
                  <li className="el-item">
                    <div className="uk-child-width-expand@m uk-grid-small" uk-grid="">
                      ...
                      <div>
                        <div className="el-content uk-panel">
                          <p>
                            An exciting 6-month Outdoor Education Diploma program
                            nestled in the woods between Hamburg, Hannover, and
                            Bremen. A life changing experience where you will live,
                            learn, and thrive in an international community.
                            Throughout the program you will be given the opportunity
                            to develop your skills in outdoor education, team
                            building and leadership. Camp Europe is committed to
                            providing you with an experiential learning environment
                            where you can grow both professionally and personally.
                            The program facilitates training, development, and
                            certification though our partners at Camp Adventure
                            Academy. If you are 21+ years old and looking for an
                            amazing program in Europe, this is the place for you.
                          </p>
                          <p>
                            The intensive training sessions focus on developing your
                            soft and hard skills, cultivating your specific outdoor
                            educational profile. Throughout the 20-week placement you
                            will have the opportunity to apply and further develop
                            these skills through experiential leaning.
                            <br /> <br />
                            You will lead activities for youth and teens, including,
                            but not limited to; rock climbing, canoeing, mountain
                            biking, hiking, camping, orienteering, group initiatives
                            and ropes course experiences. You will oversee a safe and
                            nurturing environment for our spring and summer
                            participants. You will also immerse yourself within all
                            roles at an outdoor education facility. These include
                            logistics, administrative tasks, accounting, food &
                            beverage, program planning and more. Once completed, this
                            course will have instilled in you a diverse skill set
                            that is sure to propel you into a fulfilling professional
                  ...
                  <li className="el-item">
                    <div className="uk-child-width-expand@m uk-grid-small" uk-grid="">
                      ...
                      <div>
                        <div className="el-content uk-panel">
                          <p>
                            4.5 weeks of free training (Camp Counselor, high ropes
                            course, archery, canoe, kayak, team building, survival,
                            hiking, F&B logistics, first aid, hygiene, slacklining,
                            administration)
                          </p>
                          <p>
                            Acquisition of various certificates, e.g.: First aid,
                            lifeguard, high ropes course trainer (ERCA certified),
                            TOEFL, German health certificate, Juleica (Youth Leader
                            Card)
                          </p>
                          <p>
                            16 weeks of practical work in our international camps in
                            Germany
                          </p>
                          <p>
                            2-4 weeks stay abroad in one of our partner camps in
                            Ireland or England as well as the opportunity to visit
                            our partner camps in Canada, Iceland, USA, etc. after
                      ...
                      <div>
                        <div className="el-content uk-panel">
                          <p>
                            ...
                            <br />
                            Distinctive social skills, tolerance & understanding for
                            other cultures
                            <br />
                            Openness, commitment, and a high degree of independence
                            <br />
                            Resilience
                            <br />
                            Good English skills
                    ...
                    <div className="uk-child-width-expand@m uk-grid-small" uk-grid="">
                      ...
                      <div>
                        <div className="el-content uk-panel">
                          ...
                          <p>
                            As soon as we have received and reviewed your application
                            you will receive a response from our recruitment partner{" "}
                            <a href="https://www.campeurope.net/">Camp Europe</a> via
                            e-mail. There you will invited to an online video
                            conference, where you will be assessed though a series of
                            up to three 20-30 minute interviews. Note: Non-Germans are
                            asked to submit a Pre-Interview Deposit of 75 euros (50
                            euros for Early Bird Applications) - 100% Reimbursable if
                            Camp Europe is unable to extend you a Placement Offer
                          ...
                          <p>
                            ...
                            needed for organizing your six-month program. Part of
                            confirming the spot in the program is a mandatory
                            confirmation Deposit of 500 euros (deposit for training
                            sessions) which will be FULLY reimbursed upon completion
                            of the program.
                          </p>
                        </div>
                      </div>
                  ...
                  <li className="el-item">
                    <div className="uk-child-width-expand@m uk-grid-small" uk-grid="">
                      ...
                      <div>
                        <div className="el-content uk-panel">
                          <p>
                            Please don&apos;t hesitate to ask us anything about the
                            program should you have questions. If this looks like the
                            ideal place for you, feel free to submit an online
                            application to the program. We look forward to hearing from
                            you and guiding you though our applications process for
                            the six-month Outdoor Education Program.
                          </p>
                          <p>
                            <span className="uk-text-middle">
                              <a
      ...
      <div className="uk-section-secondary uk-section-overlap uk-preserve-color uk-light">
        <div
          ...
          style={{
            backgroundImage: `url(${getTemplateImageUrl("yootheme/cache/e8/international_outdoor_education_diploma_3-e81990d3.jpeg")})`,
          }}
        >
