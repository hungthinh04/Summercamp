...
export default function AgenciesPage() {
  return (
    <>
      ...
      >
        <div
          data-src={getTemplateImageUrl("yootheme/cache/92/agenturen_header-929ed917.jpeg")}
          uk-img=""
          className="uk-background-norepeat uk-background-cover uk-background-center-center uk-section uk-section-xlarge"
          style={{
            backgroundImage: `url(${getTemplateImageUrl("yootheme/cache/92/agenturen_header-929ed917.jpeg")})`,
          }}
        >
          <div
            ...
            <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
              <div className="uk-width-1-1@m">
                ...
                <div
                  ...
                  uk-scrollspy-class=""
                >
                  <p>Reservations for individual customers, contingents for groups</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1@m">
              ...
              <div className="uk-panel uk-text-large uk-dropcap uk-column-1-2@m uk-column-1-1@s uk-margin">
                <p>
                  Our international sports, adventure &amp; language camps for kids
                  and youth from 7 to 17 years old are designed for distribution by
                  national and international agencies. For several years now, we have
                  visited well-known national and international tourism fairs such as
                  the ITB and ICEF in Berlin as well as numerous workshops at the ICF
                  (International Camping Fellowship), in which Camp Adventure serves as
                  the ambassador for Germany.
                  <br />
                  <br />
                  Direct contact with our partners from all over the globe allows us
                  to get to know the current needs of our clients and adapt our
                  programs accordingly to meet their requirements. Over the past years
                  we have developed a network of reliable partners.
                  <br />
                  How does a collaboration with Camp Adventure work?
                  <br />
                  We offer our partners the opportunity to reserve single spots for
                  individual clients or multiple spots for groups. Our partners decide
                  if they use their own or Camp Adventure&apos;s booking system. We
                  can happily provide you with promotional material (photos, video
                  clips), which you receive after having signed our agency agreement.
                  <br />
                  <br />
                  If you are interested in a collaboration please feel free to get in
                  touch with us!
                  <br />
                  <br />
        ...
        <div className="uk-container uk-container-large">
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1@m">
              ...
              <div className="uk-panel uk-text-large uk-margin">
                <p>
                  We offer various camp locations in Germany, England, and Spain with
                  a wide range of programs including sports, adventure, language
                  courses, and special activities. Contact us for more information
                  about our programs and how we can work together.
                </p>
              </div>
            </div>
          </div>
