...
export default function FamilyWeekendPage() {
  return (
    <>
      {/* Hero Section */}
      <div id="page#0" className="uk-section-default uk-section uk-padding-remove-bottom">
            ...
            <div className="uk-width-1-1@m">
              ...
              <div className="uk-panel uk-dropcap uk-column-1-2@m uk-column-1-1@s uk-margin-large uk-width-2xlarge uk-margin-auto">
                <p>
                  ...
                  at our family adventure weekends you can really let off steam.
                  Get to know our big campground, try our famous activities, and
                  experience nature with your children. It is important to us that
                  everything is laid back, voluntary and just as you like it. We
                  are not animators with whom you have to dance. We invite you to
                  experience an active weekend in the middle of the Lueneburger
                  Heide or the Bayerischer Wald with us and other families. We
                  offer a program with various activities in which you can
                  participate. Of course, you can also simply bake in the sun, go
                  swimming or explore the surroundings. A simple but delicious
                  full board is also included in the price. No matter what age
                  your children are - everyone gets their money&apos;s worth!
                </p>
              </div>
              <div
          ...
          <div className="uk-panel uk-width-1-1">
            ...
            <div className="uk-panel uk-margin-small uk-width-large uk-margin-auto uk-text-center">
              <p>
                ...
                wooden floor and gallery, the Adventure Lodges with up to 4
                bunk beds or in your own mobile home. Camping mats and sleeping
                bags can be rented on request.
              </p>
            </div>
            <div className="uk-h4 uk-text-primary uk-margin-large uk-margin-remove-bottom uk-text-center">
              Price
            ...
            <div className="uk-panel uk-margin-small uk-width-large uk-margin-auto uk-text-center">
              <p>
                - in hut for single occupancy: 149 USD per adult, children
                (4-17 years) receive 25% discount, children from 0-3 years
                free of charge.
              </p>
              <p>
                - in tent for single occupancy/own camper: 129 USD per adult,
                children (4-17 years) get 25 % discount, children from 0-3
          ...
          <div className="uk-panel uk-width-1-1">
            ...
            <div className="uk-panel uk-margin-small uk-width-large uk-margin-auto uk-text-center">
              <p>
                ...
                rooms or in your own mobile home. Camping mats and sleeping
                bags can be rented on request.
              </p>
            </div>
            <div className="uk-h4 uk-text-primary uk-margin-large uk-margin-remove-bottom uk-text-center">
          ...
          <div className="uk-grid tm-grid-expand uk-child-width-1-1">
            <div className="uk-width-1-1@m">
              <div className="uk-margin">
                <div className="uk-grid uk-child-width-1-1 uk-child-width-1-3@s uk-grid-small uk-grid-match" uk-grid="">
                  <div>
