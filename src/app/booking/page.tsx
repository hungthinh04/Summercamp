...
export const metadata: Metadata = {
  title: "Book your summer camp 2025 with Camp Adventure",
  description:
    "☀ Click here to book an international trip for your child to Germany, England or Spain ☀ Language Camp, Survival Camp, Sports Camp, Soccer Camp, etc. ☀",
};
