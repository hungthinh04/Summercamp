    ...
    <>
          ...
          <div className="uk-container uk-container-large uk-position-relative">
            <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
              <div className="uk-width-1-1@m">
                ...
                >
                  <p>
                    Learn a new language while having fun at camp!
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="uk-section-muted uk-section">
        <div className="uk-container uk-container-large">
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1@m">
              <h2 className="uk-h2 uk-text-center">Language Camps</h2>
              <div className="uk-divider-icon uk-width-medium uk-margin-auto"></div>
              <div className="uk-panel uk-dropcap uk-column-1-2@m uk-column-1-1@s uk-margin">
                <p>
                  Our language camps offer instruction in English, German, and
                  Spanish. All courses are taught by native speakers in small
                  classes, ensuring personalized attention and effective learning.
                </p>
                <p>
                  The ability to communicate in different languages is a priceless
                  gift and enables you to make friends with other campers from all
                  across the globe. Why not develop your language skills during
                  your holidays?
                </p>
              </div>
            </div>
