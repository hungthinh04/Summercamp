    ...
    <>
            ...
            <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
              <div className="uk-width-1-1@m">
                <h1
                  ...
                  uk-scrollspy-class=""
                >
                  <p>Arts & Crafts Camps in Germany</p>
                </h1>
                <div
                ...
                >
                  <p>
                    Unleash your creativity with our arts and crafts programs!
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="uk-section-muted uk-section">
        <div className="uk-container uk-container-large">
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1@m">
              <h2 className="uk-h2 uk-text-center">Arts & Crafts Camps</h2>
              <div className="uk-divider-icon uk-width-medium uk-margin-auto"></div>
              <div className="uk-panel uk-dropcap uk-column-1-2@m uk-column-1-1@s uk-margin">
                <p>
                  Our Arts & Crafts camps offer a wide variety of creative
                  activities including painting, drawing, pottery, jewelry making,
                  and more. Express yourself through art while making new friends
                  from around the world.
                </p>
                <p>
                  Perfect for creative minds who want to explore different art
                  forms and techniques in a supportive and inspiring environment.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="uk-grid uk-child-width-1-1 uk-child-width-1-2@m uk-grid-match" uk-grid="">
                <div>
                  <div className="uk-card uk-card-default uk-card-body">
                    ...
                    <p>
                      Arts & Crafts workshops at our camp in Lüneburger Heide.
                    </p>
                    <Link
                ...
                <div>
                  <div className="uk-card uk-card-default uk-card-body">
                    ...
                    <p>
                      Creative activities in the beautiful Bavarian Forest
                      setting.
                    </p>
                    <Link
