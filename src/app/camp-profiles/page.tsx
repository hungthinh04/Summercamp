...
export default function CampProfilesPage() {
  ...
  return (
    <>
              ...
              <div className="uk-panel uk-width-1-1">
                ...
                >
                  <p>
                    ...
                    disastrous camp experiences, this was our last attempt. I
                    am so glad he went! He said he had the time of his life and
                    can&apos;t wait to come back. He said the counselors were
                    fun and energetic, the food was delicious and plentiful,
                    the activities were fun, and the other campers were all very
                    nice.
                  </p>
            ...
            <div className="uk-width-1-1@m">
              <div className="uk-panel uk-text-large uk-dropcap uk-margin">
                <p>
                  ...
                  various courses that you can book as additional options to
                  our camp activities. Get an overview of what is taking
                  place where and simply decide which camp you would like to
                  spend next summer based on the program of your choice.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* Filter Form Section */}
      <div id="searchform" className="uk-section-primary uk-section-overlap uk-section">
        <div className="uk-container">
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1">
              <div className="uk-heading-small">Find your Camp!</div>
            </div>
          </div>
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1">
              <div>
                ...
                >
                  <div className="uk-width-1-4@m">
                    <label className="uk-form-label">Programs & Courses</label>
                    <select
                      id="field_4_select"
                  ...
                  <div className="uk-width-1-4@m">
                    <label className="uk-form-label">Holiday</label>
                    <select
                      id="field_5_select"
                      className="multiselect"
                      data-hidden="field_5"
