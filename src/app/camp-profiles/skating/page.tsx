          ...
          <div className="uk-container uk-container-large uk-position-relative">
            <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
              <div className="uk-width-1-1@m">
                ...
                >
                  <p>
                    Roll, skate, and have fun with our skating programs!
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="uk-grid-item-match uk-width-1-1">
              <div className="uk-card-default uk-card uk-card-body">
                <h2 className="uk-h2 uk-margin-remove-bottom uk-text-left">
                  <p>International Skate Camp in Bavaria – Learn Tricks and Make New Friends</p>
                </h2>
                <div className="uk-panel uk-dropcap uk-column-1-2@m uk-column-1-1@s uk-margin">
                  <p>
                    Whether it&apos;s skateboarding, inline skating, or riding a scooter – here at our holiday camp in Bavaria, it&apos;s all about tricks, action, and tons of fun! In the skate camp, you&apos;ll sharpen new moves, film cool clips, and push yourself to the next level alongside a bilingual, international community (English & German).
                  </p>
                  <p>
                    Community, progress & safety! Our experienced coaches, trained in first aid, guide you, teach new tricks, and ensure a safe environment—so you can fully focus on skating!<br />
                    <span style={{ fontSize: "1rem" }}>Ready for sick tricks and unforgettable sessions? Then grab your deck and drop in!</span>
                  </p>
                </div>
                <div
                    ...
                    <div className="uk-slider-items uk-grid">
                      <div className="uk-width-1-1 uk-width-3-5@s uk-width-1-2@m">
                        <div className="el-item uk-inline-clip uk-transition-toggle" tabIndex={0}>
                          <Image
                            src={getTemplateImageUrl("yootheme/cache/bc/01-Skaten%20im%20Sommercamp-bc13b84c.jpg")}
                            width={1260}
                            height={840}
                      ...
                      <div className="uk-width-1-1 uk-width-3-5@s uk-width-1-2@m">
                        <div className="el-item uk-inline-clip uk-transition-toggle" tabIndex={0}>
                          <Image
                            src={getTemplateImageUrl("yootheme/cache/6e/03-Skaten%20im%20Sommercamp-6e8bb3ae.jpg")}
                            width={1260}
                            height={840}
        ...
        <div className="uk-container uk-container-large">
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1@m">
              ...
              <div className="uk-panel uk-dropcap uk-column-1-2@m uk-column-1-1@s uk-margin">
                <p>
                  Our skating camps offer instruction in skateboarding and inline
                  skating. Learn tricks, improve your balance, and explore urban
                  skate spots under the guidance of experienced instructors.
                </p>
                <p>
