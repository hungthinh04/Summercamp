    ...
    <>
      ...
      <div className="uk-section-muted uk-section">
        <div className="uk-container uk-container-large">
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1@m">
              <h2 className="uk-h2 uk-text-center">Spanish Course in Barcelona</h2>
              <div className="uk-divider-icon uk-width-medium uk-margin-auto"></div>
              <div className="uk-panel uk-dropcap uk-column-1-2@m uk-column-1-1@s uk-margin">
                <p>
                  Our Spanish course in Barcelona offers an immersive language
                  learning experience in one of Spain&apos;s most vibrant cities.
                  Learn Spanish from native speakers while exploring the culture,
                  cuisine, and attractions of Barcelona.
                </p>
                <p>
                  Combine language learning with exciting activities including
                  water sports, beach activities, and cultural excursions in this
                  beautiful Mediterranean city.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1@m">
              <div className="uk-card uk-card-default uk-card-body">
                ...
                <p>
                  Spanish course at BISC Sailing Center in Barcelona with direct
                  access to the beach and city.
                </p>
                <Link
